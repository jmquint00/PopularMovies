...
public class Movie implements Parcelable {
    ...
    @SerializedName("total_results") private Integer mTotalResults;
    @SerializedName("total_pages") private Integer mTotalPages;
    @SerializedName("page") private Integer mPage;
    ...
    public String getReleaseDate(Context context) {
        ...
        if (mReleaseDate != null && !mReleaseDate.isEmpty()) {
            try {
                ...
                Log.e(LOG_TAG, "Release not parsed successfully: " + mReleaseDate);
